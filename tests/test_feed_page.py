...
class TestMainPage:
    ...
    def test_visible_history_orders(self, creat_login_delete_user, personal_cabinet_page, feed_page, main_page):
        ...
        list_history_orders = personal_cabinet_page.make_list_history_orders()
        main_page.go_to_orders_feed()

        assert list_history_orders in feed_page.check_visible_history_orders()

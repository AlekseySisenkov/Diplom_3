...
class TestPersonalCabinetPage:
    ...
    def test_go_to_personal_cabinet(self, creat_login_delete_user, main_page):
        main_page.go_to_personal_cabinet()

        assert main_page.check_go_to_personal_cabinet()
    ...
    def test_exit_account(self, creat_login_delete_user, personal_cabinet_page):
        personal_cabinet_page.exit_account()

        assert personal_cabinet_page.check_exit_account()
